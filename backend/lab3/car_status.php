...
<head>
  ...
  <style>
    ...
    .create-button, .sort-button, .statistics-button, .search-button {
      padding: 10px;
      text-decoration: none;
      color: white;
      background-color: #4CAF50;
...
<body>
  ...
  try {
    ...
    if ($select_tbl) {
      ...
      echo '<a href="statistics.php" class="statistics-button">Statistics</a>';
      echo '<a href="query_form.php" class="search-button">Search</a>';
      echo '</div>';
    } else {
